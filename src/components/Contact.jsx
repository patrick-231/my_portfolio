...
const Contact = () => {
  return (
    <div name='contact' className='w-full md:h-screen bg-[#0a192f] text-gray-300 flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/zaxdnwva" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
            ...
            <input className='bg-[#ccd6f6] my-4 p-2 text-black' type="email" placeholder='Email' name='email' />
